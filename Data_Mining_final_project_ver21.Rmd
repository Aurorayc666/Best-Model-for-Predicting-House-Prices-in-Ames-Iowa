...
p + theme(plot.title = element_text(size = 30, face = "bold"), axis.title=element_text(size=25,face="bold"), panel.grid.major = element_blank(), panel.grid.minor = element_blank(),axis.text.x = element_text(angle = 0, size =20), axis.text.y = element_text(angle = 0, size = 25)) + geom_text(aes(label=Test_MSE),position=position_dodge(width=0.9), hjust=-0.02, size = 7) +
